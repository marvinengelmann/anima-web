						...
						return (
							...
							>
								<AnimatePresence mode="wait" initial={false}>
									{hoveredIndex === idx && (
										<motion.span
											className="absolute inset-0 block h-full w-full rounded-2xl border border-primary/10 bg-primary/3 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] backdrop-blur-xl"
